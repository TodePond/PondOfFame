let SAVE = (
	"camera:x=191,y=836,scale=0.8506;entities:;id=3,source=FroggyOrange.png,text=Flora Caulton,x=554,y=459,z=0,scale=1.0000,rotation=0.0000;id=2,source=FroggyFlip.png,text=Luke Wilson,x=-279,y=766,z=0,scale=1.0000,rotation=0.0000;id=6,source=Grass2Flip.png,text=undefined,x=919,y=857,z=0,scale=0.7351,rotation=0.0000;id=1,source=Grass2.png,text=undefined,x=-631,y=432,z=0,scale=0.7314,rotation=0.0000;id=0,source=Colours/FroggyYellow.png,text=Sebastian Andreasson,x=394,y=1135,z=0,scale=1.0000,rotation=0.0000;id=4,source=Grass2.png,text=undefined,x=-280,y=1419,z=0,scale=0.7314,rotation=0.0000;routes:"
)
